...
const weSuggest = document.querySelector('.suggested h2') as HTMLHeadingElement;
const img = document.querySelector('.suggested img') as HTMLImageElement;
const dogBreedText = document.querySelector('.suggested h3') as HTMLHeadingElement;
const desc = document.querySelector('.suggested .desc') as HTMLParagraphElement;
const urmom = document.querySelector('.suggested h4') as HTMLHeadingElement;
...
enterBtn.onclick = getDog;
>>>>>>> 42728f0177639e2ba9229411f847ef892b317625
